package me.aevum.aevumlobby.hotbar;
...
import me.aevum.aevumlobby.util.ItemBuilder;
    ...
    private void registerDefaultItems() {
        this.registerItem("profile", new SimpleHotbarItem(
                ...
                player -> new ItemBuilder(Material.PLAYER_HEAD)
                        .name(this.configManager.getString("hotbar.items.profile.name", "<gradient:#ff6b6b:#ffd93d>Profile</gradient>"))
        ...
        this.registerItem("navigator", new SimpleHotbarItem(
                ...
                player -> new ItemBuilder(Material.COMPASS)
                        .name(this.configManager.getString("hotbar.items.navigator.name", "<gradient:#4facfe:#00f2fe>Server Navigator</gradient>"))
        ...
        this.registerItem("visibility", new SimpleHotbarItem(
                ...
                player -> {
                    final boolean visible = this.plugin.getServiceRegistry()
                            .getService(me.aevum.aevumlobby.visibility.VisibilityManager.class)
